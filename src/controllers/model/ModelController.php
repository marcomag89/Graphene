<?php
    ...
    class ModelController {
        ...
        public function getStruct() {
            ...
            //Graphene::getLogger(ModelController::class)->debug($ret);
        ...
        public function call($funct,$pars,Model $model) {
            ...
            if (Strings::startsWith($funct,'get'))
                return $this->serveGet($splitted,$model);
            elseif (Strings::startsWith($funct,'set'))
        ...
        public function getData(Model $model) {
            ...
            array_walk_recursive($struct,function (&$item,$key) {
                $item = null;
            });
            $content = array_replace_recursive($struct, $content);

            return [$model->getModelName() => $content];
        }
