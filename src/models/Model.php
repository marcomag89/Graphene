...
abstract class Model implements \Serializable {
     ...
     */
    public static function findById($id, $modelClass = null) {
        return self::findOne(['id' => $id], $modelClass);
    }
     ...
     * @throws GraphException
     */
    public static function findMatches($matchContent, $modelClass, $multiple = true, $page = null, $pageSize = -1) {
        return self::find($matchContent, $modelClass, $multiple = true, $page = null, $pageSize = -1);
    }

    /**
     * finds models that matches query
     * @param array $matchContent
     * @param string $modelClass
     * @param bool $multiple
     * @param int $page
     ...
     * @throws GraphException
     */
    public static function find($matchContent, $modelClass = null, $multiple = true, $page = null, $pageSize = -1) {
        $modelClass = $modelClass === null ? get_called_class() : $modelClass;
        ...
        if ($mod instanceof Model) {
            ...
            throw new GraphException($modelClass . " does not extends model");
        }
    }

    /**
     * finds one model that matches query
     * @param array $matchContent
     * @param string $modelClass
     *
     * @return Model | null
     * @throws GraphException
     */
    public static function findOne($matchContent, $modelClass = null) {
        $result = self::find($matchContent, $modelClass, true, null, 1);
