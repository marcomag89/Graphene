...
class GrapheneRouter {
	...
	public function getModuleStackLevel() {return count ( $this->modStack );}
	public function getModuleStack() {return $this->modStack;}
	public function getInstalledModules() {
		$ret = array ();
		foreach ( $this->modules as $md => $mod ) $ret [] = $mod;
		return $ret;
	}
	private $modules;
	private $baseUrl;
