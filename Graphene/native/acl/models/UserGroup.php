...
class UserGroup extends Model{
    ...
    public function setContent($content){
        ...
        if(array_key_exists ('userId',  $content)) $this->content['userId']=$content['userId'];
    ...
    public function securityChecks(){
        ...
        if($this->read() !== null)   throw new GraphException('user '.$this->getUserId().' already assigned at '.$this->getGroup(),400);
    }
}